...
void IslMotorControl::respondPack(unsigned char* pack) {
  int packetLength = 0;
  char tempArray[3];
  int  tempIntArray[3];
  long temp = 0x00000000;
...
void IslMotorControl::refreshPack(unsigned char* pack) {
  char temp, i;
...
unsigned char IslMotorControl::isPackValid(unsigned char* pack) {
  char temp, i;
...
void IslMotorControl::getPackedId(unsigned char* pack, char* id) {
  id[0] = pack[6];
  id[1] = pack[7];
  id[2] = pack[8];
  return;
...
boolean IslMotorControl::checkCardID(unsigned char *pack) {
...
char IslMotorControl::getPackedTask(unsigned char* pack) {
  return pack[4];
}

char IslMotorControl::getPackedLength(unsigned char* pack) {
  return pack[5];
}

char IslMotorControl::getPackedSender(unsigned char* pack) {
  return pack[3];
}

void IslMotorControl::setPackHeader(unsigned char* pack, char task, char packetLength, char* receiver) {
